...
class Admin::CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { is_default: @calendar.is_default, title: @calendar.title }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { is_default: @calendar.is_default, title: @calendar.title }
    assert_redirected_to admin_calendar_path(assigns(:calendar))
  end
